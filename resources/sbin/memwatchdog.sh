#!/bin/bash
MEMTHRESHOLD_WARN=0.1 #relative value (0.0-1.0) of free RAM to send out a warning about low RAM
MEMTHRESHOLD_SUSP=0.2 #relative value (0.0-1.0) of free RAM to initiate the container suspension
