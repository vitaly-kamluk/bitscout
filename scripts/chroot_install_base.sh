...
COMMON_PACKAGES="binutils systemd-container netcat socat casper lupin-casper discover laptop-detect os-prober bindfs dialog tmux gawk grub-pc ntpdate ifupdown network-manager curl cryptsetup"
