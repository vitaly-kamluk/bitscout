...
cp -v "./config/openvpn/${PROJECTSHORTNAME}.conf.server" "$EXPSERVER/etc/openvpn/server.conf"
...
cp -v "./config/openvpn/${PROJECTSHORTNAME}.conf.expert" "$EXPEXPERT/etc/openvpn/expert.conf"
