...
sudo grub-mkrescue -d /usr/lib/grub/i386-pc --modules="iso9660 linux ext2 fshelp ls boot" --output=./$PROJECTNAME-16.04.iso ./image -- -volid "${PROJECTNAME}-${GLOBAL_BUILDID}"
