...
then
  ...
  sed "s/<PROJECTSHORTNAME>/${PROJECTSHORTNAME}/g; s/<SERVER_IP>/${GLOBAL_VPNSERVER}/g; s/<SERVER_PORT>/${GLOBAL_VPNPORT}/g; s/<SERVER_PROTOCOL>/${CLIENTPROTOCOL}/g;" "$VPNTEMPLATEDIR/$PROJECTSHORTNAME.conf.client" > "$VPNCFGDIR/$PROJECTSHORTNAME.conf.client"
  sed "s/<PROJECTSHORTNAME>/${PROJECTSHORTNAME}/g; s/<SERVER_IP>/${GLOBAL_VPNSERVER}/g; s/<SERVER_PORT>/${GLOBAL_VPNPORT}/g; s/<SERVER_PROTOCOL>/${CLIENTPROTOCOL}/g;" "$VPNTEMPLATEDIR/$PROJECTSHORTNAME.conf.expert" > "$VPNCFGDIR/$PROJECTSHORTNAME.conf.expert"
  sed "s/<PROJECTSHORTNAME>/${PROJECTSHORTNAME}/g; s/<SERVER_IP>/${GLOBAL_VPNSERVER}/g; s/<SERVER_PORT>/${GLOBAL_VPNPORT}/g; s/<SERVER_PROTOCOL>/${SERVERPROTOCOL}/g;" "$VPNTEMPLATEDIR/$PROJECTSHORTNAME.conf.server" > "$VPNCFGDIR/$PROJECTSHORTNAME.conf.server"
